...
if len(sys.argv) != 3:
    print("Usage: python3 weights_source_residue.py <source_site> <cutoff_distance>")
    sys.exit(1)
...
subprocess.run(["python3", "extract_molecules.py", GRO_FILE, EXTRACTED_FILE, source_site, cutoff_distance])
